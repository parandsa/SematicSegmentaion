...
TRAIN_IMAGE_PATH = './data/Inputs_Train'
TRAIN_MASK_PATH = './data/Masks_Train'
TEST_IMAGE_PATH = './data/Inputs_Test'
TEST_MASK_PATH = './data/Masks_Test'
...
#4.1 show result for pre-processing stages
...
#5 Implemantaion Unet model for semantic segmentation
...
#6 Define unet model evaluator(intersection over unio _ IOU)
...
#8 train unet model using training sample
...
#9 unet model evaluation using test samples
...
#10 show final result(segmented images)
